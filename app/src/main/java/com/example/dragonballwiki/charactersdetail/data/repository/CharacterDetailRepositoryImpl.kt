...
class CharacterDetailRepositoryImpl(private val remoteDataSource: CharacterDetailRemoteDataSource, private val localDataSource: DragonListLocalDataSource) :
